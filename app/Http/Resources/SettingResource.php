...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'site_delivery_distance_threshold_1'   => $this->info['site_delivery_distance_threshold_1'] ?? '5',
            'site_delivery_distance_threshold_2'    => $this->info['site_delivery_distance_threshold_2'] ?? '10',
            'site_delivery_cost_1'                 => $this->info['site_delivery_cost_1'] ?? '5',
            'site_delivery_cost_2'                 => $this->info['site_delivery_cost_2'] ?? '8',
            'site_delivery_cost_3'                 => $this->info['site_delivery_cost_3'] ?? '12',
