...
<script>
import ItemComponent from "../table/components/ItemComponent";
import itemDesignEnum from "../../enums/modules/itemDesignEnum";
import statusEnum from "../../enums/modules/statusEnum";
import alertService from "../../services/alertService";
import LoadingComponent from "../table/components/LoadingComponent";

export default {
    name: "OnlineSearchItemComponent",
    components: {
        ItemComponent,
        LoadingComponent
    },
    ...
    mounted() {
        this.props.search.branch_id = this.$route.params.branchId;
