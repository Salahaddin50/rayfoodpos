                ...
                <table class="db-table stripe" id="print" :dir="direction">
                    <thead class="db-table-head">
                        <tr class="db-table-head-tr">
                            ...
                            <th class="db-table-head-th">{{ $t("label.whatsapp") }}</th>
...
export default {
    ...
    mounted() {
        ...
        // Listen for breadcrumb refresh button (Online Orders)
        window.addEventListener('rayfood:refresh-online-orders', this.onExternalRefresh);
    },
    beforeUnmount() {
        window.removeEventListener('rayfood:refresh-online-orders', this.onExternalRefresh);
    },
    computed: {
        orders: function () {
    ...
    methods: {
        ...
        clear: function () {
            ...
            this.props.search.order_type = orderTypeEnum.DELIVERY;
