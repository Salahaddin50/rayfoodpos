<template>
    ...
    <div id="onlineUserUpload" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">{{ $t("menu.online_users") }}</h3>
...
export default {
    name: "OnlineUserUploadComponent",
    ...
    methods: {
        ...
        save() {
            ...
            this.$store
                .dispatch("onlineUser/import", { form: fd })
                .then(() => {
                    this.loading.isActive = false;
                    appService.modalHide();
                    alertService.successFlip(0, this.$t("menu.online_users"));
                    this.file = "";
                    this.errors = {};
                    this.$refs.fileProperty.value = null;
                    this.$emit("list");
