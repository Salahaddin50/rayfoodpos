...
use App\Http\Controllers\Admin\TakeawayTypeController;
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('token')->name('token.')->group(function () {
        ...
        Route::post('/reset', [TokenController::class, 'reset']);
        Route::get('/current-counter', [TokenController::class, 'currentCounter']);
    });
    ...
    Route::prefix('takeaway-type')->name('takeaway-type.')->group(function () {
        Route::get('/', [TakeawayTypeController::class, 'index']);
        Route::get('/show/{takeawayType}', [TakeawayTypeController::class, 'show']);
        Route::post('/', [TakeawayTypeController::class, 'store']);
        Route::match(['post', 'put', 'patch'], '/{takeawayType}', [TakeawayTypeController::class, 'update']);
        Route::delete('/{takeawayType}', [TakeawayTypeController::class, 'destroy']);
        Route::get('/export', [TakeawayTypeController::class, 'export']);
    });
